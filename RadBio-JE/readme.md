...
Abyste mohli nástroj RadBio-JE používat,  potřebujete open-source program QGIS, který si bezplatně [stáhnete zde](https://www.qgis.org/en/site/forusers/download.html) - pro firemní použití je doporučována aktuální LTR verze QGIS 3.28.5 'Firenze'- instalační soubor pro 64bit Windows [stáhnete zde](https://qgis.org/downloads/QGIS-OSGeo4W-3.28.5-1.msi). Podrobný postup instalace najdete v [dokumentaci](https://github.com/juhele/RadBio/blob/main/RadBio%20-%20Dokumentace%20k%20SW%20-%20k%2030.1.23.pdf) od strany 13.
